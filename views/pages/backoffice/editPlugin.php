...
<form action="<?= $routerService->urlFor('pluginEditAction', ['name' => $name]) ?>" method="post">
	...
	<div <?php if (isset($flash['description'][0]) or isset($flash['description'][0])): ?>style="color:red"<?php endif; ?>>
		...
		<input type="text" name="description" id="description" <?php if (isset($formOldValues['description'])): ?>value="<?= $formOldValues['description'] ?>"<?php else: ?>value="<?= $description ?>"<?php endif; ?>>
	...
	<div <?php if (isset($flash['versionPlugin'][0])): ?>style="color:red"<?php endif; ?>>
		...
		<input type="text" name="versionPlugin" id="versionPlugin" <?php if (isset($formOldValues['versionPlugin'])): ?>value="<?= $formOldValues['versionPlugin'] ?>"<?php else: ?>value="<?= $versionPlugin ?>"<?php endif; ?>>
	...
	<div <?php if (isset($flash['versionPluxml'][0])): ?>style="color:red"<?php endif; ?>>
		...
		<input type="text" name="versionPluxml" id="versionPluxml" <?php if (isset($formOldValues['versionPluxml'])): ?>value="<?= $formOldValues['versionPluxml'] ?>"<?php else: ?>value="<?= $versionPluxml ?>"<?php endif; ?>>
