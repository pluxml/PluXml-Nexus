...
<p><a href="<?= $routerService->urlFor('boeditplugin', ['name' => $plugins[0]['name']]) ?>"><?= $plugins[0]['name'] ?></a></p>
<p><a href="<?= $routerService->urlFor('boeditplugin', ['name' => $plugins[1]['name']]) ?>"><?= $plugins[1]['name'] ?></a></p>
<p><a href="<?= $routerService->urlFor('boeditplugin', ['name' => $plugins[2]['name']]) ?>"><?= $plugins[2]['name'] ?></a></p>